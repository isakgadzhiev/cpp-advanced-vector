...
// "Магическое" число, используемое для отслеживания живости объекта
    ...
    struct Obj {
        ...
        static void Print() {
            std::cout << "default_construction_throw_countdown: " << default_construction_throw_countdown << std::endl
                    << "num_copied: " << num_copied << std::endl
                    << "num_moved: " << num_moved << std::endl
                    << "num_destroyed: " << num_destroyed << std::endl
                    << "num_constructed_with_id: " << num_constructed_with_id << std::endl
                    << "num_constructed_with_id_and_name: " << num_constructed_with_id_and_name << std::endl
                    << "num_assigned: " << num_assigned << std::endl
                    << "num_move_assigned: " << num_move_assigned << std::endl;
        }
